...
import '../ad_hoc_reporting_screen/widgets/listtext_item_widget.dart';
                ...
                child: BlocSelector<AdHocReportingBloc, AdHocReportingState,
                  ...
                  builder: (context, adHocReportingModelObj) {
                    return ListView.separated(
                      ...
                      itemCount:
                          adHocReportingModelObj?.listtextItemList.length ?? 0,
                      itemBuilder: (context, index) {
                        ListtextItemModel model =
                            adHocReportingModelObj?.listtextItemList[index] ??
                                ListtextItemModel();
